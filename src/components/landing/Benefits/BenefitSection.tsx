...
const BenefitSection: React.FC<Props> = ({ benefit, imageAtRight }: Props) => {
    ...
    return (
        <section className="benefit-section">
            <motion.div
                className="flex flex-wrap flex-col items-center justify-center gap-2 lg:flex-row lg:gap-20 lg:flex-nowrap mt-10 mb-24"
            ...
            >
                ...
                <div className={clsx("mt-5 lg:mt-0", { "lg:order-2": imageAtRight })}>
                    <div className={clsx("w-fit flex", { "justify-start": imageAtRight, "justify-end": !imageAtRight })}>
                        <Image src={imageSrc} alt="title" height="384" width="762" quality={100} className="lg:ml-0 lg:mr-0 rounded-xl shadow-lg " />
                    </div>
                </div>
            </motion.div>
        </section>
